...
urlpatterns = [
    ...
    path('<slug:business_id>/areasdenegocio/<slug:id>', ver_areadenegocio, name='detail-areasdenegocio'),
    path('<slug:business_id>/areasdenegocio/delete/<slug:id>', eliminar_areadenegocio, name='delete-areasdenegocio'),
    path('<slug:business_id>/areasdenegocio/edit/<slug:id>', editar_areadenegocio, name='edit-areasdenegocio')
]